          ...
          <div class="flex justify-between h-16">
            <div class="flex items-center gap-6">
              <div class="flex-shrink-0 flex items-center">
                <a routerLink="/cars" class="flex items-center group">
                  <div class="w-10 h-10 gradient-primary rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg smooth-transition">
                    <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM15 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"/>
                      <path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1V5a1 1 0 00-1-1H3zM14 7a1 1 0 00-1 1v6.05A2.5 2.5 0 0115.95 16H17a1 1 0 001-1v-5a1 1 0 00-.293-.707l-2-2A1 1 0 0015 7h-1z"/>
                    </svg>
                  </div>
                  <h1 class="ml-3 text-lg font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent hidden lg:block">
                    Inventario de Autos
                  </h1>
                </a>
              </div>
            ...
            <div class="flex items-center gap-4">
              @if (authService.user(); as user) {
                <div class="hidden md:flex items-center bg-gradient-to-r from-indigo-50 to-purple-50 px-4 py-2.5 rounded-lg shadow-sm">
                  <svg class="w-5 h-5 text-indigo-600 mr-2.5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div class="flex space-x-6">
              <button class="text-sm text-gray-500 hover:text-gray-900 smooth-transition cursor-pointer">
