...
@Component({
  ...
  template: `
    <div
      class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 px-4 sm:px-6 lg:px-8 py-12"
    >
          ...
          <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="space-y-6">
            ...
            <div class="smooth-transition">
              ...
              @if (registerForm.get('password')?.invalid && registerForm.get('password')?.touched) {
                <div
                  class="mt-2 bg-red-50 border-l-4 border-red-500 rounded-lg p-3 animate-slide-up"
                >
            ...
            <div class="text-center pt-4 border-t border-gray-200">
              <p class="text-sm text-gray-600">
                ...
                <a
                  routerLink="/login"
                  class="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 smooth-transition"
                >
                  Inicia sesión aquí
                </a>
              </p>
