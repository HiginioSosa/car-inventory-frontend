    ...
    <div class="min-h-screen py-6 sm:py-12 animate-slide-up">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if (authService.user(); as user) {
          <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100 hover:shadow-2xl smooth-transition">
            <div class="px-6 py-8 sm:px-8 gradient-primary">
              <div class="flex flex-col sm:flex-row items-center sm:items-start">
                <div class="flex-shrink-0">
                  <div class="h-24 w-24 sm:h-28 sm:w-28 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-lg ring-4 ring-white/30">
                ...
                <div class="mt-4 sm:mt-0 sm:ml-6 text-center sm:text-left">
                  <h2 class="text-2xl sm:text-3xl font-bold text-white drop-shadow-sm">{{ user.name }}</h2>
                  <p class="text-base sm:text-lg text-white/90 mt-1">{{ user.email }}</p>
                  <div class="mt-3 inline-flex items-center px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-sm">
            ...
            <div class="px-6 py-8 sm:px-8">
              ...
              <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-100">
                  <dt class="text-xs font-medium text-gray-600 uppercase tracking-wider mb-2">Nombre Completo</dt>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-100">
                  <dt class="text-xs font-medium text-gray-600 uppercase tracking-wider mb-2">Correo Electrónico</dt>
                  <dd class="text-base font-semibold text-gray-900 flex items-center break-all">
                    <svg class="w-5 h-5 mr-2 text-purple-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-gradient-to-br from-yellow-50 to-orange-50 p-4 rounded-xl border border-yellow-100">
                  <dt class="text-xs font-medium text-gray-600 uppercase tracking-wider mb-2">Rol</dt>
                  <dd class="mt-1">
                    <span
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-5 sm:px-8 border-t border-gray-200">
              <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <a routerLink="/cars" class="inline-flex items-center px-5 py-2.5 rounded-lg gradient-primary text-white font-medium hover:shadow-xl smooth-transition hover-lift">
          ...
          <div class="mt-6 sm:mt-8 bg-white shadow-xl rounded-2xl p-6 sm:p-8 border border-gray-100 animate-fade-in">
            ...
            <div class="space-y-4">
              <div class="flex items-center text-sm sm:text-base text-gray-700 bg-green-50 p-4 rounded-xl border border-green-200">
                <svg
